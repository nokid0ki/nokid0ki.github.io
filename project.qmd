...
We will investigate the average rental prices of HDB flats and its trends. The scope of this analysis involves rental prices between 2021 to 2023, covering 1 to 5 room flats. The data set used is publicly available [here](https://beta.data.gov.sg/collections/166/view)! 😆 All the graphs here are interactive, feel free to hover of them to get the relevant data.
...
Hover over the area to view the planning area, and click upon it to view the mean rental price! (Edit: WIP in calculating mean per HDB type + considering making this into a Shiny app)
...
Edit: Considering making this entire section into a Shiny app for better consolidation
...
Interestingly, there does not seem to be a direct correlation between how long it takes to get to work and the mean monthly rent. I guess everyone just needs a place to stay hahah. (Edit: may edit this scatter plot to make it easier to understand)
